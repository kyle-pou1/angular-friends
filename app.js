...
angular.module('angularFriends').controller('FriendController', function($scope) {
  ...
  $scope.friends = [
    {
      "name": "Preston McNeil",
      "pic_square": "https://images-na.ssl-images-amazon.com/images/M/MV5BMTM0MDc4MzE5NF5BMl5BanBnXkFtZTcwNTU3NjYyMQ@@._V1_UY317_CR6,0,214,317_AL_.jpg",
      "current_location": {
        "city": "Houston",
        "state": "Texas",
